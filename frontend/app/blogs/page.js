...
export default function BlogListing() {
    ...
    const addBlogListingSchema = (blogs) => {
        const schema = {
    ...
    return (
        <>
            <Head>
                <title>Seedite Blog | NSAT Preparation & Tech Career Insights</title>
                <meta name="description" content="Get expert insights on NSAT exam preparation, coding tips, and tech career guidance. Stay updated with the latest trends in technology education." />
                <meta property="og:title" content="Seedite Blog | NSAT Preparation & Tech Career Insights" />
                <meta property="og:description" content="Expert insights on NSAT exam preparation, coding tips, and tech career guidance" />
                <meta property="og:type" content="website" />
                <meta property="og:url" content="https://www.seedite.in/blogs" />
                <meta name="twitter:card" content="summary_large_image" />
                <meta name="twitter:title" content="Seedite Blog" />
                <meta name="twitter:description" content="NSAT Preparation & Tech Career Insights" />
            </Head>
